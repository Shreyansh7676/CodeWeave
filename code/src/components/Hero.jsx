          ...
          <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-6 md:p-8 shadow-2xl">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex space-x-2">
                  <input
                    ...
                    className="flex-1 bg-gray-700/50 border border-gray-600 rounded-lg px-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
                  />
                  <button
                ...
                {generatedRoomId && (
                  <div className="bg-gray-700/30 border border-gray-600/50 rounded-lg p-3 flex items-center justify-between">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 disabled:from-gray-600 disabled:to-gray-600 disabled:cursor-not-allowed text-white font-semibold py-4 px-6 rounded-lg transition-all flex items-center justify-center space-x-2 text-lg"
              >
                {isLoading ? (
