...
const CollaborativeTextEditor = () => {
    ...
    useEffect(() => {
        const init = async () => {
            ...
            try {
                const res = await axios.get(`${import.meta.env.VITE_APP_BACKEND_URL2}/api/room/${id}`);
    ...
    const handleSave = async () => {
        try {
            ...
            const response = await axios.post(`${import.meta.env.VITE_APP_BACKEND_URL2}/api/room/${id}/save`, {
                code: codeRef.current || ''
            });
    ...
    const handleAI = async () => {
        ...
        try {
            const res = await axios.post(`${import.meta.env.VITE_APP_BACKEND_URL2}/api/ai`, { prompt });
            const data = res.data;
            if (data.text) {
